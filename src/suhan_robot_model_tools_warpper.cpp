...
BOOST_PYTHON_MODULE(suhan_robot_model_tools_wrapper_cpp)
{
  ...
  bp::class_<MultiChainWithFixedOrientationConstraint, boost::noncopyable>("MultiChainWithFixedOrientationConstraint")
      ...
      .def("jacobian", &MultiChainWithFixedOrientationConstraint::jacobian)
