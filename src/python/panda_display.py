...
from suhan_robot_model_tools.suhan_robot_model_tools_wrapper_cpp import PlanningSceneCollisionCheck, NameVector, IntVector, TripleChainConstraintsFunctions, isometry_to_vectors
...
# ik_adaptor = TRACIKAdapter('panda_left', 'panda_left_link0', 'panda_left_link8', 0.1, 1e-6, '/robot_description')
